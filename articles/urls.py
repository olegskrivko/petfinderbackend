...
router.register(r'articles', ArticleViewSet)  # Route for articles
...
urlpatterns = [
    ...
    path('articles/<int:article_id>/paragraphs/', ParagraphViewSet.as_view({'get': 'list'})),  # Fetch paragraphs for an article
]