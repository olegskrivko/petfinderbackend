...
### ✅ Serializer for Reset Password (Sets New Password)
# class ResetPasswordSerializer(serializers.Serializer):
#     password = serializers.CharField(write_only=True)
#     token = serializers.CharField()
...
#         user.set_password(self.validated_data["password"])
#         user.clear_password_reset_token()  # ✅ Calls model method
#         return {"message": "Password reset successfully!"}
# class RegisterSerializer(serializers.ModelSerializer):
#     password = serializers.CharField(write_only=True)  # ✅ Prevent returning password in response
#     email = serializers.EmailField(required=True)  # ✅ Ensure email is required

#     class Meta:
#         model = User
#         fields = ['email', 'password', 'username']  # ✅ Include username in response
...
#         validated_data["username"] = generate_hex_username()  # ✅ Generate unique username
